...
class ExporterMetrics:
    def __init__(self, printer_name: str, serial: str) -> None:
        ...
        self.fan_secondary_aux_speed = Gauge("bambulab_fan_secondary_aux_speed_percent", "Secondary auxiliary fan speed percent", label_names, registry=self.registry)
    ...
    def update_from_snapshot(self, snapshot: PrinterSnapshot) -> None:
        ...
        self._set_optional(self.fan_secondary_aux_speed, snapshot.fan_secondary_aux_percent)
