...
class ExporterMetrics:
    def __init__(self, printer_name: str, site: str, location: str) -> None:
        ...
        self.fan_gear_raw = Gauge("bambulab_fan_gear_raw", "Raw fan_gear value from MQTT", label_names, registry=self.registry)
    ...
    def update_from_snapshot(self, snapshot: PrinterSnapshot) -> None:
        ...
        self._set_optional(self.fan_gear_raw, snapshot.fan_gear_raw)
